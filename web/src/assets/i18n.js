...
const messages = {
  en: {
    ...
    message: {
      ...
      startfail: "Failed to start container: {err}",
      starttip:
        "Enter the Docker container name to start. Default is 'palworld'.",
  ...
  zh: {
    ...
    message: {
      ...
      startfail: "启动容器失败: {err}",
      starttip: "输入要启动的 Docker 容器名称，默认为 'palworld'。",
  ...
  ja: {
    ...
    message: {
      ...
      startsuccess: "コンテナが正常に起動しました！",
      broadcastfail: "全体メッセージ配信に失敗しました: {err}",
      shutdownfail: "シャットダウンに失敗しました: {err}",
      startfail: "コンテナの起動に失敗しました: {err}",
      starttip:
        "起動するDockerコンテナ名を入力してください。デフォルトは「palworld」です。",
